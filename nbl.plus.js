 ...
 * Copyright (c) 2010 Berklee. Additional input from Knowlecules.
...
this.nbl = {
  ...
  a: function(u,l) {
    var s, t, m = this, n = u[0].replace(/.+\/|\.min\.js|\.js$|\W/gi, ''), k = {js: {t: "script", a: "src"}, css: {t: "link", a: "href"}, "i": {t: "img", a: "src"}}; // Clean up the name of the script for storage in the queue
